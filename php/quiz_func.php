...
EOF;
     ...
     * @return string
     */
    public function fetchDefaultAnswer($adminStatus, $memberId)
    {
...
EOF;
     ...
     * @return int 新規ゲームID
     */
    public function registerQuizGameId()
    {
        // ゲームID 設定
        $sql = <<< EOF
            SELECT
...
EOF;
        $stmt = $this->dbh->query($sql);
        $superSatoshikunPowerPoint = $stmt->fetch(PDO::FETCH_COLUMN);
